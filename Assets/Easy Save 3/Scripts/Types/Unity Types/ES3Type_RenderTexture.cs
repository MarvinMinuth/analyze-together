...
namespace ES3Types
{
    ...
    public class ES3Type_RenderTexture : ES3ObjectType
    {
        ...
        protected override void WriteObject(object obj, ES3Writer writer)
        {
            ...
            writer.WriteProperty("masterTextureLimit", UnityEngine.QualitySettings.globalTextureMipmapLimit, ES3Type_int.Instance);
            ...
            foreach (string propertyName in reader.Properties)
            {
                switch (propertyName)
                {
                    ...
                    case "masterTextureLimit":
                        UnityEngine.QualitySettings.globalTextureMipmapLimit = reader.Read<System.Int32>(ES3Type_int.Instance);
                        break;
